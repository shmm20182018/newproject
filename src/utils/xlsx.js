...
const xlsxUtils = (function () {
	var t = {
		Binary: {
			fixdata: function (e) {
				for (var r = "", t = 0, n = 10240; t < e.byteLength / n; ++t)
					r += String.fromCharCode.apply(null, new Uint8Array(e.slice(t * n, t * n + n)));
		...
		_wb: null,
		_rABS: !1,
		convertNum2Letter:function(num){
			return num <= 26 ? 
		...
		getCharCol: function (e) {
			for (var r = "", t = 0; e > 0; )
				t = e % 26 + 1, r = String.fromCharCode(t + 64) + r, e = (e - t) / 26;
			return r
		}
	};
	return t
